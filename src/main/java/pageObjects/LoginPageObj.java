...
public class LoginPageObj extends Base{
	...
	public LoginPageObj() {
		PageFactory.initElements(driver, this); // Using reference variable of WebDriver in Base class and Initialize object at this page by using this keyword.
	}
	...
	@FindBy(id = "input-email")   	//input[@id='input-email']
