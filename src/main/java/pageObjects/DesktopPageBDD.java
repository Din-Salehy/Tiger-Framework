...
public class DesktopPageBDD extends Base {

	public DesktopPageBDD() {
...
// We Also can use below methods.
	
//	public String HPLPSuccessMessage() {
//	String actualText = HPLPsuccessMsField.getText();
//	return actualText;	
//}

//(//a[text()='HP LP3065'])[3]" --> this should be used for below method.
//public String successMsg() {
//	String actualText = "Success: You have added "+HPLPsuccessMsField.getText()+" to your shopping cart!";
//	return actualText;
//}
...
//	public String canonSuccesMessage() {
//		String actualtext =canonSuccessFeild.getText();
//		return actualtext;
//	}

//	@FindBy(xpath = "(//a[text()='Canon EOS 5D Camera'])[3]") --> This xpath should be used for below method	
//	public String canonSuccessMsg() {
//		String actualMsg = "Success: You have added "+canonSuccessFeild.getText()+" to your shopping cart!";
//		return actualMsg;
//	}
